...
export default function ShotResultOverlay({ show, shotData, onComplete }: Props) {
        ...
        >
          ...
          >
            ...
            <motion.div
              ...
              className={`text-7xl font-black mb-4 ${isMade ? 'text-green-400' : 'text-red-400'}`}
              style={{
                textShadow: isMade
            ...
            >
              <div className="text-3xl font-bold text-white mb-2">
                ...
                {shotData.teamTricode && (
                  <span className="ml-2 text-xl opacity-75">({shotData.teamTricode})</span>
                )}
              </div>
              <div className="flex items-center justify-center gap-4 text-lg">
                {shotData.shotType && (
                  <span className="px-3 py-1 bg-white/10 rounded-full">{shotData.shotType}</span>
                )}
            ...
            {shotData.shotLocation && (
              ...
              >
                ...
                <motion.div
                  ...
                  className={`absolute w-6 h-6 rounded-full ${isMade ? 'bg-green-400' : 'bg-red-400'}`}
                  style={{
                ...
                >
                  <motion.path
                    d={`M ${shotData.shotLocation.x * 2.56} ${shotData.shotLocation.y * 2.56} Q 128 64 128 240`}
              ...
              <>
                {[...Array(20)].map((_, i) => (
                  <motion.div
                    ...
                    style={{
                      backgroundColor: ['#fbbf24', '#10b981', '#3b82f6', '#ef4444'][i % 4],
                      left: '50%',
                      top: '20%'
                    }}
